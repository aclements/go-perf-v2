...
func (c *DeltaCell) Render(svg *SVG, scales *Scales, prev Cell, prevRight float64) {
	x, y := scales.X, scales.Y

	// Draw bars where the top and bottom are absolute start and
	// end, and phases are spaced out on the X axis.
	const hMargin = 0.1
